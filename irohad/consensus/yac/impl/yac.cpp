...
namespace iroha {
  namespace consensus {
    namespace yac {
      ...
      void Yac::applyCommit(nonstd::optional<std::shared_ptr<shared_model::interface::Peer>> from,
      ...
      void Yac::applyReject(nonstd::optional<std::shared_ptr<shared_model::interface::Peer>> from,
      ...
      void Yac::applyVote(
          nonstd::optional<std::shared_ptr<shared_model::interface::Peer>> from,
          VoteMessage vote) {
        if (from.has_value()) {
